...
train_LR_dir <- paste(train_dir, "LR_base/", sep="")
train_HR_dir <- paste(train_dir, "HR_base/", sep="")
...
if(run.cv){
  ...
  plot(model_values, err_cv[,1], xlab="Interaction Depth", ylab="CV Error",
       main="Cross Validation Error", type="n", ylim=c(min(err_cv[,1])*0.97,max(err_cv[,1])*1.03))
...
if(run.test){
  ...
  print(superResolution(test_LR_dir, test_HR_dir, fit_train))
}
```
